  ...
  _createClass(Player, [{
    ...
    value: function loadMusic() {
      ...
      $.getJSON('https://jirenguapi.applinzi.com/fm/getSong.php?public_tuijian_ktv', {
        ...
        _this.song = xxx.song[0];
        console.log(xxx);
        window.a = xxx.song[0]; // _this.audio.src = _this.song.url
        // _this.$('.header p').innerText = _this.song.artist;
        // _this.$('.header h1').innerText = _this.song.title;
      });
    }
  }]);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/control.js"], null)
//# sourceMappingURL=/control.078737a5.js.map